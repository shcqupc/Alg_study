...
def set_Cabin_type(df):
    df.loc[(df.Cabin.notnull()), 'Cabin'] = "Yes"  # set Cabin value to Yes for which notnull is True
...
#print(data_train.iloc[0:5,1:5])
# print((data_train.Cabin.notnull()))
print(type(rfr))
...
# fit / predict
# (6) 绘制learning curve
plot_learning_curve(clf, u"学习曲线learning curve", X, y)
